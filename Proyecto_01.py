...
class SistemaGEOS:
    ...
    def crear_interfaz(self):
        ...
        tk.Button(frame_herramientas, text="Agregar Nuevo", font=("Arial", 10, "bold"), bg="white", fg=self.COLOR_AZUL,
                  relief="solid", borderwidth=2, cursor="hand2", padx=15, pady=5, command=self.agregar_item).pack(
            side="left", padx=5)
    ...
    def mostrar_proveedores(self):
        ...
        # Crear barra de herramientas para proveedores
        frame_herramientas = tk.Frame(self.frame_contenido, bg=self.COLOR_FONDO)
        frame_herramientas.pack(fill="x", pady=(0, 15))
        ...
        self.tabla_proveedores.column("ID", width=80, anchor="center")
        self.tabla_proveedores.column("Nombre", width=200, anchor="w")
        self.tabla_proveedores.column("Código", width=120, anchor="center")
        self.tabla_proveedores.column("Teléfono", width=120, anchor="center")
        self.tabla_proveedores.column("Encargado", width=180, anchor="w")
        self.tabla_proveedores.column("Información", width=300, anchor="w")
...
class VentanaAgregar:
    def __init__(self, parent, sistema):
        ...
        tk.Label(self.ventana, text="Agregar Nuevo Ítem", font=("Arial", 18, "bold"), bg="#FFFFFF", fg=COLOR_AZUL).pack(
            pady=20)

        frame_form = tk.Frame(self.ventana, bg="#FFFFFF")
        frame_form.pack(padx=40, pady=10, fill="both", expand=True)

        tk.Label(frame_form, text="ID:", font=("Arial", 11, "bold"), bg="#FFFFFF").grid(row=0, column=0, sticky="w",
                                                                                        pady=10)
        self.entry_id = tk.Entry(frame_form, font=("Arial", 11), width=30)
        self.entry_id.grid(row=0, column=1, pady=10, padx=10)

        tk.Label(frame_form, text="Nombre:", font=("Arial", 11, "bold"), bg="#FFFFFF").grid(row=1, column=0, sticky="w",
                                                                                            pady=10)
        self.entry_nombre = tk.Entry(frame_form, font=("Arial", 11), width=30)
        self.entry_nombre.grid(row=1, column=1, pady=10, padx=10)

        tk.Label(frame_form, text="Cantidad:", font=("Arial", 11, "bold"), bg="#FFFFFF").grid(row=2, column=0,
                                                                                              sticky="w", pady=10)
        self.entry_cantidad = tk.Entry(frame_form, font=("Arial", 11), width=30)
        self.entry_cantidad.grid(row=2, column=1, pady=10, padx=10)

        tk.Label(frame_form, text="Precio:", font=("Arial", 11, "bold"), bg="#FFFFFF").grid(row=3, column=0, sticky="w",
                                                                                            pady=10)
...
class VentanaEditar:
    def __init__(self, parent, sistema, item):
        ...
        tk.Label(self.ventana, text="Editar Ítem", font=("Arial", 18, "bold"), bg="#FFFFFF", fg=COLOR_AZUL).pack(
            pady=20)
